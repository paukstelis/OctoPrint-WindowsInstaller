...
Head to the [latest release](https://github.com/paukstelis/OctoPrint-WindowsInstaller/releases/latest) and download the built installer from the latest version.
